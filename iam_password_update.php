...
<html lang="en">
	<head>
		...
		<title>Azure IAM Dashboard - IAM Password Update</title>
						...
						<div class="">
							<div class="header-logo">
								<a href="index.html" class="logo">
									<h1>Azure IAM Dashboard - IAM Password Update</h1>
								</a>
							</div>
						</div>
						<!-- /LOGO -->
...
<?php
    $out=shell_exec('C:/Apache24/htdocs/azure-dashboard/scripts/iam_password_update.bat');
    echo "<pre>$out</pre>";
?>
